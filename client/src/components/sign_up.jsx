...
the signup view has a Input Box with text :l located at the mid-top in the center of the view
signup view has Label located at the main area left of the view, text needs identified
signup view has a Label located at the mid-bottom center of the view with text ﬂ
      ...
      <Row>
        {!data.error_message && show_loading_indicator === true ? (
          ...
          <Col md={12}>
            ...
            <Col md={12}>
              <p className="label-light-turquoise-light-sky-blue-paragraph">
                {" "}
                ﬂ{" "}
              </p>
            </Col>
